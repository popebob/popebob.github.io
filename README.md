...
- **Application & Data Layer:** Reverse Proxies & Web Servers, SQL & NoSQL Databases, Databricks, Message Bus/Queuing, Caching Systems
...
- Hoylu's first dedicated DevOps/Platform Engineering hire; retained and expanded scope through multiple company-wide workforce reductions.
...
- Led development of a Kubernetes-based, metal-up enterprise application hosting platform in a private data center — high availability with no cloud abstraction layer — with direct CTO-level engagement.
...
- Lead architect and agile coach across a concurrent Platform-as-a-Service portfolio, influencing hundreds of engineers with developer experience as a first-class design concern.
...
- Grew a regional IT role into North American leadership scope, establishing data-driven ITIL practices.
